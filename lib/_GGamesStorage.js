    ...
    this.setGameCode = (html) => {
        ...
        return new Promise((r) => setTimeout(async () => {
            ...
            const scripts = [
                ...
                "https://lib.qrpr.eu/GUtils/GUt.js",
                "https://lib.qrpr.eu/GEngine/GEngine.js",
                "https://lib.qrpr.eu/GScore/GScore.js",
                "https://lib.qrpr.eu/GThread/GThread.js",
                "https://lib.qrpr.eu/GRenderer/GRenderer.js"
            ];
            const styles = [
