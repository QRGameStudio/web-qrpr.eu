    ...
    this.setGameCode = (html) => {
        ...
        return new Promise((r) => setTimeout(() => {
            ...
            if (gameData.showFooter) {
                ...
                // TODO: remove temporary theme switch
                footer.innerHTML = `<a href="http://qrgamestudio.com/">Powered By QRGameStudio</a>
<a style='margin-left: 16px' href='' onclick="new GTheme().get() === 'light' ? localStorage.setItem('theme', 'dark') : localStorage.setItem('theme', 'light')">Change theme</a>`;
